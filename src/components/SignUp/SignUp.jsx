...
// import meeting2 from "../../assets/meeting2.png"; // Remove unused image import
import "./Signup.css";
...
const SignUpForm = () => {
  ...
  const handleRegister = useCallback(async (e) => {
    e.preventDefault();
    let submitable = true;
    if (captchaVal.toLowerCase() !== captchaText.toLowerCase()) { // Case-insensitive comparison
      alert("Wrong Captcha");
      setCaptchaVal("");
      generateCaptcha();
      return;
    ...
    <main>
      <div className="signup-container">
        <div className="parent">
          <div className="right">
            <h1 className="counsellor">Pathguider</h1>
